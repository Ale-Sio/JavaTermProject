...
/**
 * The WUGTest class tests the graph.WUGraph class.
 */
...
public class WUGTest {
    ...
    private static int edgeTest(Object[] vertArray) {
        ...
        if (neigh == null) {
            ...
            System.out.println("getNeighbors(vertex 3) returns array containing" +
                    " wrong objects.");
            System.out.println(neigh.neighborList[0] + " " +  vertArray[3]);
            System.out.println(neigh.neighborList[1] + " " +  vertArray[7]);
            System.out.println(neigh.neighborList[0] + " " +  vertArray[7]);
            System.out.println(neigh.neighborList[1] + " " +  vertArray[3]);
            getDeduction = 1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Your graph.WUGraph test score is " + (0.5 * (double) score) +
                " out of 7.0.");
